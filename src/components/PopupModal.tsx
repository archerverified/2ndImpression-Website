  ...
  if (showConfirmation) {
    return (
      ...
      >
        ...
        <div className="relative z-10 bg-white rounded-[24px] shadow-[0px_8px_24px_0px_rgba(149,157,165,0.2)] w-full max-w-[500px] p-8 border-[3px] border-[rgba(17,17,17,0.1)]">
          {/* Header */}
          <div className="mb-6">
