      ...
      >
        ...
        <div className="relative z-10 bg-white rounded-[16px] sm:rounded-[24px] shadow-[0px_8px_24px_0px_rgba(149,157,165,0.2)] w-full max-w-[500px] max-h-[90vh] overflow-y-auto p-5 sm:p-8 border-[2px] sm:border-[3px] border-[rgba(17,17,17,0.1)]">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            <p className="font-['Product_Sans',sans-serif] text-[14px] sm:text-[16px] text-[#111] leading-[22px] sm:leading-[24px] mb-3 sm:mb-4">
            ...
            <p className="font-['Product_Sans',sans-serif] text-[14px] sm:text-[16px] text-[#111] leading-[22px] sm:leading-[24px]">
              Best,<br />
          ...
          <div className="flex justify-end">
            <button
              onClick={handleConfirmationClose}
              className="bg-[#0048ff] h-[44px] sm:h-[48px] px-6 sm:px-8 rounded-[10px] sm:rounded-[12px] flex items-center justify-center hover:bg-[#0040dd] transition-colors font-['Product_Sans',sans-serif] font-bold text-[14px] sm:text-[16px] text-white"
            >
              OK
            </button>
          </div>
    ...
    >
      ...
      <div className="relative z-10 bg-white rounded-[16px] sm:rounded-[24px] shadow-[0px_8px_24px_0px_rgba(149,157,165,0.2)] w-full max-w-[500px] max-h-[90vh] overflow-y-auto p-5 sm:p-8 border-[2px] sm:border-[3px] border-[rgba(17,17,17,0.1)]">
        ...
        <div className="text-center mb-4 sm:mb-6">
          <p className="font-['RocaOne-Bl',sans-serif] text-[24px] sm:text-[32px] text-[#0048ff] mb-2">
            Happy New Years!
          </p>
          <h2 id="modal-title" className="font-['Product_Sans',sans-serif] font-bold text-[18px] sm:text-[24px] text-black leading-tight">
        ...
        {/* Description */}
        <div className="text-center mb-4 sm:mb-6">
          <p className="font-['Product_Sans',sans-serif] text-[14px] sm:text-[17px] text-[rgba(17,17,17,0.65)] leading-[22px] sm:leading-[24px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          <div className="rounded-full overflow-hidden border-2 border-[#0048ff] bg-white">
            <input
              ...
              className="w-full h-[48px] sm:h-[56px] px-4 sm:px-6 bg-transparent border-none outline-none font-['Product_Sans',sans-serif] text-[14px] sm:text-[16px] text-center text-black placeholder:text-[#a5a8ae]"
              required
          ...
          <button
            type="submit"
            className="w-full bg-black h-[48px] sm:h-[56px] rounded-full flex items-center justify-center hover:bg-[#222] transition-colors font-['Product_Sans',sans-serif] font-bold text-[16px] sm:text-[18px] text-white"
          >
            Send me my GPT! 🤖
          </button>
        </form>
        ...
        {/* Footer */}
        <p className="text-center text-[10px] sm:text-[12px] text-[rgba(17,17,17,0.6)] font-['Product_Sans',sans-serif] mt-4 sm:mt-6">
