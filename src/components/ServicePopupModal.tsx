...
export function ServicePopupModal({ service, onClose }: ServicePopupModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* Modal Content */}
      <div className="relative z-10 bg-white rounded-[24px] shadow-[0px_8px_24px_0px_rgba(149,157,165,0.2)] w-full max-w-[720px] p-10 lg:p-12 border-[3px] border-[rgba(17,17,17,0.1)]">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="text-center mb-4">
          <h2
            ...
            className="font-['RocaOne-Bl',sans-serif] text-[28px] lg:text-[32px] text-[#0048ff] leading-tight"
          >
            {content.headline}
          </h2>
        </div>
        ...
        <div className="text-center mb-8">
          <p className="font-['Product_Sans',sans-serif] text-[16px] lg:text-[18px] text-[rgba(17,17,17,0.7)] leading-[26px]">
            {content.subheadline}
          </p>
        </div>
          ...
          <ul className="space-y-4">
            {content.benefits.map((benefit, index) => (
              <li key={index} className="flex items-start gap-3">
                <CheckIcon />
                <span className="font-['Product_Sans',sans-serif] text-[16px] lg:text-[17px] text-[#111] leading-[24px]">
                  {benefit}
                </span>
              </li>
            ))}
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <a
            ...
            className="flex-1 bg-[#0048ff] h-[56px] rounded-[12px] flex items-center justify-center hover:bg-[#0040dd] transition-colors shadow-[0px_1px_2px_0px_rgba(0,0,0,0.1),0px_3px_3px_0px_rgba(0,0,0,0.09),0px_7px_4px_0px_rgba(0,0,0,0.05),0px_12px_5px_0px_rgba(0,0,0,0.01)]"
          >
            <span className="font-['Product_Sans',sans-serif] font-bold text-[18px] lg:text-[20px] leading-[30px] text-white">
              {content.ctaLabel}
            </span>
          </a>
        </div>
